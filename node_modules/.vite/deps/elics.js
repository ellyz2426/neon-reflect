...
// ../immersive-web-sdk/node_modules/.pnpm/elics@3.4.2/node_modules/elics/lib/types.js
var Types;
(function(Types2) {
  Types2["Int8"] = "Int8";
  Types2["Int16"] = "Int16";
  Types2["Int32"] = "Int32";
  Types2["Entity"] = "Entity";
  Types2["Float32"] = "Float32";
  Types2["Float64"] = "Float64";
  Types2["Boolean"] = "Boolean";
  Types2["String"] = "String";
  Types2["FilePath"] = "FilePath";
...
// ../immersive-web-sdk/node_modules/.pnpm/elics@3.4.2/node_modules/elics/lib/checks.js
var CHECKS_ON = true;
...
(function(ErrorMessages2) {
  ErrorMessages2["TypeNotSupported"] = "Type not supported";
  ErrorMessages2["InvalidDefaultValue"] = "Invalid default value";
  ErrorMessages2["InvalidEnumValue"] = "Invalid enum value";
  ErrorMessages2["InvalidRangeValue"] = "Value out of range";
...
// ../immersive-web-sdk/node_modules/.pnpm/elics@3.4.2/node_modules/elics/lib/bit-set.js
var BitSet = class _BitSet {
  ...
  or(other) {
    var _a, _b;
    const out = new _BitSet(new Uint32Array(Math.max(this.words.length, other.words.length)));
...
// ../immersive-web-sdk/node_modules/.pnpm/elics@3.4.2/node_modules/elics/lib/entity.js
var Entity = class {
  constructor(entityManager, queryManager, componentManager, index) {
    ...
    this.active = true;
    this.generation = 0;
    this.vectorViews = /* @__PURE__ */ new Map();
  }
  ...
  getValue(component, key) {
    ...
    const data = indexed ? indexed[this.index] : void 0;
  ...
  setValue(component, key, value) {
    ...
    switch (type) {
      ...
      case Types.Float64:
        ...
        break;
      case Types.Entity:
        componentData[this.index] = this.entityManager.packEntityRef(value);
        break;
      default:
        componentData[this.index] = value;
        break;
  ...
  getVectorView(component, key) {
    ...
    if (cachedVectorView) {
      ...
      if (!this.vectorViews.has(component)) {
        this.vectorViews.set(component, /* @__PURE__ */ new Map());
      }
...
// ../immersive-web-sdk/node_modules/.pnpm/elics@3.4.2/node_modules/elics/lib/component.js
...
ComponentRegistry.components = /* @__PURE__ */ new Map();
...
function initializeComponentStorage(component, entityCapacity) {
  ...
  for (const key in s) {
    ...
    assertCondition(length === 1 || Array.isArray(defaultValue) && defaultValue.length === length, ErrorMessages.InvalidDefaultValue, key);
  }
}
  ...
  for (const key in s) {
    ...
    switch (type) {
      case Types.Entity: {
        ...
        dataRef[index] = entityInput ? (entityInput.generation & 255) << 24 | entityInput.index & 16777215 : -1;
        break;
      }
      case Types.Enum:
      ...
      case Types.Object:
        ...
        break;
      case Types.Color: {
        const length2 = TypedArrayMap[type].length;
...
// ../immersive-web-sdk/node_modules/.pnpm/elics@3.4.2/node_modules/elics/lib/component-manager.js
var ComponentManager = class {
  ...
  hasComponent(component) {
    return component.typeId !== -1 && this.componentsByTypeId[component.typeId] === component;
  }
...
// ../immersive-web-sdk/node_modules/.pnpm/elics@3.4.2/node_modules/elics/lib/entity-manager.js
var EntityManager = class {
  ...
  requestEntityInstance() {
    ...
    if (this.poolSize > 0) {
      ...
      entity.active = true;
      entity.generation = entity.generation + 1 & 255;
    } else {
  ...
  packEntityRef(entity) {
    ...
    return (entity.generation & 255) << 24 | entity.index & 16777215;
  }
  /**
  ...
  getEntityByPackedRef(packedRef) {
    ...
    const index = packedRef & 16777215;
    const generation = packedRef >>> 24 & 255;
...
// ../immersive-web-sdk/node_modules/.pnpm/elics@3.4.2/node_modules/elics/lib/query.js
var Query = class {
  constructor(requiredMask, excludedMask, queryId, valuePredicates = []) {
    ...
    this.subscribers = {
      qualify: /* @__PURE__ */ new Set(),
      disqualify: /* @__PURE__ */ new Set()
    };
  ...
  matches(entity) {
    if (!this.excludedMask.isEmpty() && this.excludedMask.intersects(entity.bitmask)) {
      return false;
    }
      ...
      for (const p of this.valuePredicates) {
        ...
        switch (p.op) {
          ...
          case "ne":
            ...
            break;
          case "lt":
            if (!(typeof v === "number" && typeof p.value === "number" && v < p.value)) {
              return false;
            }
            break;
          case "le":
  ...
  static generateQueryInfo(queryConfig) {
    ...
    const preds = rawPreds.map((p) => {
      ...
      switch (p.op) {
        ...
        case "gt":
        case "ge":
          if (!(t === Types.Int8 || t === Types.Int16 || t === Types.Int32 || t === Types.Float32 || t === Types.Float64)) {
    ...
    const whereStr = preds.map((p) => `${p.component.typeId}:${p.key}:${p.op}=${Array.isArray(p.value) ? "arr" : String(p.value)}`).join(",");
    return {
      requiredMask,
      excludedMask,
...
// ../immersive-web-sdk/node_modules/.pnpm/elics@3.4.2/node_modules/elics/lib/query-manager.js
var QueryManager = class {
  constructor(componentManager) {
    this.componentManager = componentManager;
    this.queries = /* @__PURE__ */ new Map();
    this.trackedEntities = /* @__PURE__ */ new Set();
    this.queriesByComponent = /* @__PURE__ */ new Map();
    this.queriesByValueComponent = /* @__PURE__ */ new Map();
  }
  registerQuery(query) {
    var _a, _b, _c;
  ...
  updateEntity(entity, changedComponent) {
    ...
    const queries = changedComponent ? (_a = this.queriesByComponent.get(changedComponent)) !== null && _a !== void 0 ? _a : [] : this.queries.values();
...
// ../immersive-web-sdk/node_modules/.pnpm/elics@3.4.2/node_modules/elics/lib/world.js
var World = class {
  constructor({ entityCapacity = 1e3, checksOn = true, entityReleaseCallback } = {}) {
    this.systems = [];
    this.globals = {};
...
// ../immersive-web-sdk/node_modules/.pnpm/elics@3.4.2/node_modules/elics/lib/system.js
function createSystem(queries = {}, schema = {}) {
  ...
  return _a = class {
    constructor(world, queryManager, priority) {
      ...
      for (const key in schema) {
        const k = key;
        this.config[k] = y(schema[k].default);
      }
    }
    get globals() {
  ...
  }, _a.schema = schema, _a.isSystem = true, _a.queries = queries, _a;
}

// ../immersive-web-sdk/node_modules/.pnpm/elics@3.4.2/node_modules/elics/lib/version.js
var VERSION = "3.4.2";

// ../immersive-web-sdk/node_modules/.pnpm/elics@3.4.2/node_modules/elics/lib/query-helpers.js
function eq(component, key, value) {
  return { component, key, op: "eq", value };
}
function ne(component, key, value) {
  return { component, key, op: "ne", value };
}
function lt(component, key, value) {
  return { component, key, op: "lt", value };
}
function le(component, key, value) {
  return { component, key, op: "le", value };
}
function gt(component, key, value) {
  return { component, key, op: "gt", value };
}
function ge(component, key, value) {
  return { component, key, op: "ge", value };
}
function isin(component, key, values) {
  return { component, key, op: "in", value: values };
}
function nin(component, key, values) {
  return { component, key, op: "nin", value: values };
}
export {
  ComponentRegistry,
  Entity,
